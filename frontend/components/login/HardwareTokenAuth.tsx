    ...
    <div className="space-y-4 font-mono text-xs">
      ...
      <div className="p-4 bg-[#070A10] border border-slate-800 rounded-xl space-y-3">
        ...
        <div className="grid grid-cols-2 gap-2 text-[10.5px]">
          <div className="p-2 bg-[#0E1424] rounded border border-slate-800">
            <div className="text-slate-500 text-[10px]">PCR-7 Binding:</div>
            <div className="text-cyan-400 font-bold truncate">SECURE_BOOT_ENCLAVE</div>
          </div>
          <div className="p-2 bg-[#0E1424] rounded border border-slate-800">
            <div className="text-slate-500 text-[10px]">Hardware Token:</div>
      ...
      <div className="p-4 bg-[#070A10] border border-slate-800 rounded-xl space-y-3">
        <div className="flex items-center justify-between">
          ...
          <span className="text-[10px] text-slate-500 font-sans">6-digit Enclave PIN</span>
        </div>
        ...
        <div className="flex items-center justify-between gap-2">
          ...
          <button
            type="button"
            onClick={handleClear}
            className="px-3 py-2 bg-slate-800 hover:bg-slate-700 text-slate-300 rounded-lg text-[10px] border border-slate-700 transition-colors"
          >
            Clear
          </button>
        </div>
            ...
            if (k === 'DEV') {
              return (
                <button
                  ...
                  className="p-2 bg-slate-900/60 border border-slate-800/80 hover:bg-slate-800 text-cyan-400 rounded-lg text-[10px] font-bold transition-all"
